...
export class Backend implements backendInterface {
    ...
    async addPhoto(arg0: string, arg1: string, arg2: string, arg3: ExternalBlob): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.addPhoto(arg0, arg1, arg2, await to_candid_ExternalBlob_n8(this._uploadFile, this._downloadFile, arg3));
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
...
async function from_candid_PhotoMetadata_n12(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _PhotoMetadata): Promise<PhotoMetadata> {
...
async function from_candid_opt_n18(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: [] | [_PhotoMetadata]): Promise<PhotoMetadata | null> {
    return value.length === 0 ? null : await from_candid_PhotoMetadata_n12(_uploadFile, _downloadFile, value[0]);
}
...
async function from_candid_vec_n11(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: Array<_PhotoMetadata>): Promise<Array<PhotoMetadata>> {
    return await Promise.all(value.map(async (x)=>await from_candid_PhotoMetadata_n12(_uploadFile, _downloadFile, x)));
}
